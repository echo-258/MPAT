test_cases = {
    ...
    "multiple_encoding_value_valid_latter": {
        "data":
            ...
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Disposition: attachment; filename=att\r\n"
            b"Content-Transfer-Encoding: quoted-printable, base64\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
        ,
    ...
    "CTE_value_abnormal_case": {
        "data":
            b"MIME-Version: 1.0\r\n"
            b"Subject: CTE_value_abnormal_case\r\n"
            b"Content-Type: multipart/mixed; boundary=foo\r\n"
            b"\r\n"
            b"--foo\r\n"
            b"Content-Type: text/plain\r\n"
    ...
    "CTE_value_with_0_start": {
        "data":
            ...
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Disposition: attachment; filename=att\r\n"
            b"Content-Transfer-Encoding: \0base64\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
        ,
    ...
    "CTE_value_with_0_mid": {
        "data":
            b"MIME-Version: 1.0\r\n"
            b"Subject: CTE_value_with_0_mid\r\n"
            b"Content-Type: multipart/mixed; boundary=foo\r\n"
            b"\r\n"
            b"--foo\r\n"
            b"Content-Type: text/plain\r\n"
    ...
    "CTE_value_overlap": {
        "data":
            ...
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Disposition: attachment; filename=att\r\n"
            b"Content-Transfer-Encoding: base64base64\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
        ,
    ...
    "CTE_value_invalid_base64dash": {
        "data":
            b"MIME-Version: 1.0\r\n"
            b"Subject: CTE_value_invalid_base64dash\r\n"
            b"Content-Type: multipart/mixed; boundary=foo\r\n"
            b"\r\n"
            b"--foo\r\n"
            b"Content-Type: text/plain\r\n"
    ...
    "abnormal_line_break_between_headers_rc": {
        "data":
            ...
            b"--foo\r\n"
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Disposition: attachment; filename=att\r\x13"
            b"Content-Transfer-Encoding: base64\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
    ...
    "abnormal_line_break_between_headers_cn": {
        "data":
            ...
            b"--foo\r\n"
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Disposition: attachment; filename=att\x13\n"
            b"Content-Transfer-Encoding: base64\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
    ...
    "comment_CTE_wrap_invalid": {
        "data":
            b"MIME-Version: 1.0\r\n"
            b"Subject: comment_CTE_wrap_invalid\r\n"
            b"Content-Type: multipart/mixed; boundary=foo\r\n"
            b"\r\n"
            b"--foo\r\n"
            b"Content-Type: text/plain\r\n"
    ...
    "comment_CTE_half_wrap_end_rn": {
        "data":
            ...
            b"--foo\r\n"
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Transfer-Encoding: base64(quoted\r\n"
            b"Content-Disposition: attachment; filename=att\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
    ...
    "comment_CTE_half_wrap_end_r": {
        "data":
            ...
            b"--foo\r\n"
            b"Content-Type: application/octet-stream; name=att\r\n"
            b"Content-Transfer-Encoding: base64(quoted\r"
            b"Content-Disposition: attachment; filename=att\r\n"
            b"\r\n"
            b"<specified_payload_here>"
            b"--foo--\r\n"
    ...
    "ecdw_CTE_all_encode_char": {
        "data":
            b"MIME-Version: 1.0\r\n"
            b"Subject: ecdw_CTE_all_encode_char\r\n"
            b"Content-Type: multipart/mixed; boundary=foo\r\n"
            b"\r\n"
            b"--foo\r\n"
            b"Content-Type: text/plain\r\n"
